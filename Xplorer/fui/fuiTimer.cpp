...
namespace fui {
	...
	extern queue<int> objectPool, timerPool;
	extern vector<object> objectData;
	extern vector<timer> timerData;
	extern HWND fuihWindow;
	extern HDC fuihDC;
	extern HBITMAP fuiBitmap;
	extern fuiObject *fuiObjectRoot;
	extern int fuiBitmapWidth, fuiBitmapHeight;
	extern int fuiFocus, fuiLastMove;
	extern WNDPROC fuiOriginalProc;
	int fuiTimer::id() {
		return _id;
	}
