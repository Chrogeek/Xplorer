...
HBITMAP gdiCreateBitmap(HDC hDC, int width, int height, VOID **lplpVoid) {
	class tmpclass {
	public:
		BITMAPINFO b;
	};
...
void gdiRecreateBitmap(HDC &hDC, HBITMAP &bitmap, int width, int height, VOID **lplpVoid) {
...
HPEN gdiCreatePen(HDC hDC, int color, int width, int style) {
